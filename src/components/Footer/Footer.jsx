...
const SOCIALS = [
  ...
  { icon: 'play_circle', label: 'TikTok', href: 'https://tiktok.com' },
]
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            {submitted ? (
              <div className="flex items-center gap-3 bg-red-600 px-4 py-3 mt-2">
                <span className="material-symbols-outlined text-white text-base">check_circle</span>
                <span className="font-label-bold uppercase text-xs tracking-widest text-white">You're on the list!</span>
              </div>
            ) : (
              <form onSubmit={handleNewsletter} className="flex mt-2">
                <input
                  type="email"
                  value={email}
                ...
                <button
                  type="submit"
                  className="bg-red-600 hover:bg-white hover:text-black text-white px-4 py-3 font-label-bold uppercase text-xs tracking-widest transition-all duration-200 flex-shrink-0"
                >
